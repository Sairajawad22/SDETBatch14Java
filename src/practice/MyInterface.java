...
interface Function extends Outputs {
    void adding(double firstNumber ,double SecondNumber2);
    void subtracting(double firstNumber ,double SecondNumber2);
    void  multiply(double firstNumber ,double SecondNumber2);
    void dividing(double firstNumber ,double SecondNumber2);
}
